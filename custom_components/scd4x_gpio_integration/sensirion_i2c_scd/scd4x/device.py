...
class Scd4xI2cDevice(I2cDevice):
    ...
    async def async_read_serial_number(self):
        """
        ...
        :rtype: int
        """
        return await self.async_execute(Scd4xI2cCmdGetSerialNumber())

    async def async_start_periodic_measurement(self, power_mode=Scd4xPowerMode.HIGH):
        """
        ...
        if power_mode == Scd4xPowerMode.HIGH:
            result = await self.async_execute(Scd4xI2cCmdStartPeriodicMeasurement())
        elif power_mode == Scd4xPowerMode.LOW:
            result = await self.async_execute(Scd4xI2cCmdStartLowPowerPeriodicMeasurement())
        else:
    ...
    async def async_read_measurement(self):
        ...
        :rtype: tuple
        """
        return await self.async_execute(Scd4xI2cCmdReadMeasurement())

    async def async_stop_periodic_measurement(self):
        """
        Stop periodic measurement.

        .. note:: this command is only available in periodic measurement mode
        """
        return await self.async_execute(Scd4xI2cCmdStopPeriodicMeasurement())

    async def async_get_temperature_offset(self):
        """
        ...
        .. note:: Only available in idle mode.
        """
        return await self.async_execute(Scd4xI2cCmdGetTemperatureOffset())

    async def async_set_temperature_offset(self, t_offset):
        """
        ...
        """
        return await self.async_execute(Scd4xI2cCmdSetTemperatureOffset(t_offset))

    async def async_get_sensor_altitude(self):
        """
        ...
        .. note:: Only available in idle mode.
        """
        return await self.async_execute(Scd4xI2cCmdGetSensorAltitude())

    async def async_set_sensor_altitude(self, sensor_altitude):
        """
        ...
        .. note:: Only available in idle mode.
        """
        return await self.async_execute(Scd4xI2cCmdSetSensorAltitude(sensor_altitude))

    async def async_set_ambient_pressure(self, ambient_pressure):
        """
        ...
        """
        return await self.async_execute(Scd4xI2cCmdSetAmbientPressure(ambient_pressure))

    async def async_perform_forced_recalibration(self, target_co2_concentration):
        """
        ...
        :rtype: int
        """
        return await self.async_execute(Scd4xI2cCmdPerformForcedRecalibration(target_co2_concentration))

    async def async_get_automatic_self_calibration(self):
        """
        ...
        :rtype: int
        """
        ret = await self.async_execute(Scd4xI2cCmdGetAutomaticSelfCalibration())
        return ret == 1

    async def async_set_automatic_self_calibration(self, asc_enabled):
        """
        ...
        if asc_enabled:
            ...
            value = 0
        return await self.async_execute(Scd4xI2cCmdSetAutomaticSelfCalibration(value))

    async def async_get_data_ready_status(self):
        """
        ...
        :rtype: bool
        """
        ret = await self.async_execute(Scd4xI2cCmdGetDataReadyStatus())
        return (ret & 0x07FF) > 0

    async def async_persist_settings(self):
        """
        ...
        """
        return await self.async_execute(Scd4xI2cCmdPersistSettings())

    async def async_perform_self_test(self):
        """
        ...
        :rtype: int
        """
        return await self.async_execute(Scd4xI2cCmdPerformSelfTest())

    async def async_perform_factory_reset(self):
        """
        ...
        .. note:: To avoid unnecessary wear of the EEPROM, this command should only
                  ...
                  a separate EEPROM dimensioned for specified sensor lifetime.
        """
        return await self.async_execute(Scd4xI2cCmdPerformFactoryReset())

    async def async_reinit(self):
        """
        Reinit I²C Command
        ...
        .. note:: Only available in idle mode.
        """
        return await self.async_execute(Scd4xI2cCmdReinit())

    async def async_measure_single_shot(self):
        """
        ...
        .. note:: Only available in idle mode.
        """
        return await self.async_execute(Scd4xI2cCmdMeasureSingleShot())

    async def async_measure_single_shot_rht_only(self):
        """
        ...
        .. note:: Only available in idle mode.
        """
        return await self.async_execute(Scd4xI2cCmdMeasureSingleShotRhtOnly())

    async def async_power_down(self):
        """
        ...
        .. note:: Only available in idle mode.
        """
        return await self.async_execute(Scd4xI2cCmdPowerDown())
    ...
    async def async_wake_up(self):
        ...
        """
        try:
            await self.async_execute(Scd4xI2cCmdWakeUp())
        except I2cNackError:
